...
const T = {
  sk: {
    ...
    'visual.sound.title': 'Zvukové efekty',
    'visual.sound.on': 'Zvuky zapnuté',
    'visual.sound.off': 'Zvuky vypnuté',
    'visual.haptic.title': 'Haptická odozva (vibrácie)',
    'visual.haptic.on': 'Haptická odozva zapnutá',
    'visual.haptic.off': 'Haptická odozva vypnutá',
    'visual.anim.section': 'ANIMÁCIE',
    'visual.anim.title': 'Animácie',
    ...
    'ext.leaderCrown': 'Korunka pre lídra',
    'ext.leaderCrown.sub': 'Aktuálny líder má pri mene korunku',
  ...
  en: {
    ...
    'visual.sound.title': 'Sound effects',
    'visual.sound.on': 'Sounds on',
    'visual.sound.off': 'Sounds off',
    'visual.haptic.title': 'Haptic feedback (vibration)',
    'visual.haptic.on': 'Haptic feedback on',
    'visual.haptic.off': 'Haptic feedback off',
    'visual.anim.section': 'ANIMATIONS',
    'visual.anim.title': 'Animations',
    ...
    'ext.leaderCrown': 'Leader crown',
    'ext.leaderCrown.sub': 'Current leader has a crown next to their name',
